...
function find_all_posts() {
    ...
    while($row = mysqli_fetch_assoc($select_posts)) {
        ...
        <?php
            ...
            echo "<td><a rel='$post_id' post-title='$post_title' href='' class='delete_link'><i class='fa fa-trash trash-post' aria-hidden='true' data-toggle='tooltip' title='Delete Post'></i></a></td>";         
